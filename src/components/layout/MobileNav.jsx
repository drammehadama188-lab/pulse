              ...
              {all.map((item) => {
                ...
                return (
                  <NavLink
                    ...
                    className={`flex flex-col items-center gap-1.5 rounded-2xl py-3 text-[11px] font-semibold ${active ? 'bg-[var(--color-brand-50)] text-[var(--color-brand)]' : 'text-[var(--color-ink-soft)]'}`}
                  >
